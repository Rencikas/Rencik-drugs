...
RegisterServerEvent('RN-drugs:outofbound', function()
	outofbound = true
end)

RegisterServerEvent('RN-drugs:quitprocess', function()
	can = false
end)
...
RegisterServerEvent('RN-drugs:processCannabis', function()
...
RegisterServerEvent('RN-drugs:cancelProcessing', function()
...
RegisterServerEvent("RN-drugs:sell", function(itemName, amount, price)
    local xPlayer = ESX.GetPlayerFromId(source)
